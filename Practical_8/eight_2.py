...
import numpy as np
# ---------- Load binary image ----------
image_path = 'img2.png' # Replace with your binary image
...
for op_name, op_img in morph_ops.items():
 ...
 print(f"{op_name}: Number of objects = {len(areas)}, Areas = {areas}") # Draw contours on a copy for visualization
